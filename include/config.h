...
typedef struct
{
  ...
  Filename manure_sedac_p_filename;  /* names of the N manure files */
  Filename manure_sedac_n_filename;  /* names of the P manure files */
  Filename manure_n_crop_filename;  /* names of the P manure files */
  Filename manure_n_past_filename;  /* names of the P manure files */

  Filename wastewater_n_filename;  /*name of the N wastewater file */
  Filename wastewater_p_filename;  /*name of the N wastewater file */
  Filename wastewater_c_filename;  /*name of the N wastewater file */
  Filename fert_n_filename;
  Filename fert_p_filename;

  int with_nitrogen; // 0 if no use of nitrogen
  int with_wastewater; // 0 if no input of N/P from wastewater
  int with_ferti;  // 0 if no input of N/P fertilizers
  int with_manure;  // 0 if no input of N/P manure
  int init_phyto;  //  1 if phytoplankton should be initialised.
  int with_nutdrainanddep ;//0 if no nutrient drainage nor atmospheric deposition
  Filename pulsefrac_filename; //  Name of the pulse crop surface file (year x country)
  Filename nopulsefrac_filename; //  Name of the no pulse crop surface file (year x country)
  Filename grassfrac_filename; //  Name of the grassland surface file (year x country)
  int frac_firstyear;  //  first year in the surface files
  int frac_lastyear;  // last year in the surface files
