...
extern Real daily_agriculture_grass(Stand *,Real,Dailyclimate,int,
                              Real,const Real [],Real,
                              Real,Real,Real,Real,Real,Real,int,int,int,
                              Bool,Bool,const Config *,int);
extern Bool annual_agriculture_grass(Stand *,int,int,Real,int,Bool,const Config *);

extern void output_gbw_agriculture_grass(Output *,const Stand *,Real,Real,Real,Real,
