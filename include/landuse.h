...
/* barrier.n */
/* application structure determining whether the first,
 * second or third application of manure/fertilizers should
 * be applied (1) or not (0)
 */
...
typedef struct
{
  ...
  // barrier.n
  int *sowing_date;    /* sowing day of the preceding year for all the CFTs (not sure that it is still used) */
  Application *application;    /*manure application */
