...
typedef struct
{
    ...
    Real mNO3discharge;      /* barrier.n monthly NO3 discharge */
    Real mNH4discharge;      /* barrier.n monthly NH4 discharge */
    Real mPO4discharge;      /* barrier.n monthly PO4 discharge */
    Real mPO4adsdischarge;      /* monthly PO4 adsorbed discharge */
    Real mPhytoCdischarge;   /* barrier.n: monthly discharge of Phyto Carbon */
    Real mNO3_SOIL[NSOILLAYER]; /* barrier.n: NO3 (DIN) per soillayer g/kg of soil*/
    Real mPO4_SOIL[NSOILLAYER]; /* barrier.n: NH4 (DIN) per soillayer g/kg of soil*/
    Real mNH4_SOIL[NSOILLAYER]; /* barrier.n: PO4 (DIP) per soillayer g/kg of soil */
    Real mRESC_SOIL[NSOILLAYER]; /* g/kg */
    Real mRESN_SOIL[NSOILLAYER]; /* g/kg */
    Real mRESP_SOIL[NSOILLAYER]; /* g/kg*/
    Real mDECC_SOIL[NSOILLAYER]; /* g/kg of soil*/
    Real mDOCdischarge;      /* barrier.n monthly DOC discharge */
    Real mDONdischarge;      /* barrier.n monthly DON discharge */
    Real mDOPdischarge;      /* barrier.n monthly DOP discharge */
    Real mNO3_LAKE;// mol/L
    Real mPO4_LAKE;// mol/L
    Real mNH4_LAKE;// mol/L
    Real mPHY_LAKE;// gC/dm3
    Real mUPTRESDIFF; //g/m2 difference between uptake of P and the P residue produced
    Real mNWastewater; //monthly NO3 quantity into wastewaters g
    Real mPO4Wastewater; //monthly PO4 quantity into wastewaters g
    Real mNferti; //g
    Real mPO4ferti; // g
    Real mNmanure; // g
    Real mPO4manure; // g
...
typedef struct
{
    ...
    float *mNO3discharge;      /* barrier.n: monthly NO3 discharge */
    float *mPO4discharge;      /* barrier.n: monthly PO4 discharge */
    float *mPO4adsdischarge;      /* monthly PO4 adsorbed discharge */
    float *mNH4discharge;      /* barrier.n: monthly NH4 discharge */
    float *mPhytoCdischarge;   /* barrier.n: monthly discharge of Phyto Carbon */
    float *mDOCdischarge;      /* barrier.n monthly DOC discharge */
    float *mDONdischarge;      /* barrier.n monthly DON discharge */
    float *mDOPdischarge;      /* barrier.n monthly DOP discharge */
    float *mNO3_SOIL;
    float *mPO4_SOIL;
    float *mNH4_SOIL;
    float *mRESC_SOIL;
