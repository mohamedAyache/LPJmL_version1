...
/**                                                                       **/
/**     Last change: 20.10.2009 by Christoph Mueller & Elke Stehfest      **/
...
void reclaim_land(const Stand *stand1,Stand *stand2,Cell *cell,Bool istimber, int ntotpft)
{
    ...
    /* Create new stands (stand2) from natural stands (or setaside stand, stand1), and to ensure consistency in fractions and pools.
     * Source: Wiki
     */
