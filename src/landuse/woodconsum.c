...
/**                                                                       **/
/**     Last change: 08.06.2009, M. Gumpenberger, U. Heyder               **/
/**     Last change: 11.06.2009, W. von Bloh                              **/
/**                                                                       **/
/***************************************************************************/
...
/*               [#indiv]/[#indiv]     [gC/m2]  /      [gC/m2]          */
  ...
  tree->residue.root+=(disturb*tree->ind.root+disturb*tree->ind.sapwood/3.0)+(1-max_frac)*flux;
  litter->ag[pft->litter].trait.leaf+=disturb*tree->ind.leaf; /* cannot be burned, send to litter*/
  tree->residue.leaf+=disturb*tree->ind.leaf;
