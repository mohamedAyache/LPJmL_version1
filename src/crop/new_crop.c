...
void new_crop(Pft *pft)
{
    ...
    /* barrier.n: set everything to 0 */
    crop->residue.so = crop->residue.root = crop->residue.pool = crop->residue.leaf = 0.0;
    crop->uptake.so = crop->uptake.root = crop->uptake.pool = crop->uptake.leaf = 0.0;
    crop->annual_uptake.so = crop->annual_uptake.root = crop->annual_uptake.pool = crop->annual_uptake.leaf = 0.0;
