        ...
        )
{
    ...
    // barrier.n
    // WARNING: to check what is the pool reservoir in CFTS
    crop->residue.leaf += (crop->ind.pool + crop->ind.leaf)*frac;
    crop->residue.so += (crop->ind.so)*frac;
    ...
    // barrier.n
    crop->residue.root += crop->ind.root*frac;
