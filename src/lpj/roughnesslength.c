...
static const Real zb = 100.0;     /* height where the roughness is sensible (m) [in accordance with Max Planck GCM]. */
                                  /* minimal boundary layer thickness in SPEEDY */

static const Real z0bare = 0.005; /* smooth surface roughness length (m) */
...
Real roughnesslength(const Standlist standlist
